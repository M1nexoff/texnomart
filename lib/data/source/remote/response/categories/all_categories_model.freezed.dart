...
mixin _$AllCategoriesModel {
  ...
  /// Serializes this AllCategoriesModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AllCategoriesModel
...
mixin _$AllCategoriesItem {
  ...
  /// Serializes this AllCategoriesItem to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AllCategoriesItem
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
mixin _$AllCategoriesItemChild {
  ...
  /// Serializes this AllCategoriesItemChild to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AllCategoriesItemChild
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
